"""Operator public-key registry for attestation aggregator.

Used to verify the signed challenge an operator must present before the
aggregator issues an `AttestationReport` (CRIT-SVC-002, MED-SVC-012).
"""
